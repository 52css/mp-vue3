...
if(n.add(t),e--,Wt(t))Se(t.value,e,n);else if(Zt(t))for(let s=0;s<t.length;s++)Se(t[s],e,n);else if("Set"===te(t)||function(t){return"Map"===te(t)}(t))t.forEach((t=>{Se(t,e,n)}));else if(ne(t)){for(const s in t)Se(t[s],e,n);for(const s of Object.getOwnPropertySymbols(t))Object.prototype.propertyIsEnumerable.call(t,s)&&Se(t[s],e,n)}return t}function Re(t){if(function(t){const e=new Set(["undefined","boolean","number","string"]);return null===t||e.has(typeof t)}(t)||se(t))return t;if(Wt(t))return Re(t.value);if(At(t))return Re(Mt(t));if(Zt(t))return t.map((t=>Re(t)));if(ne(t)){const e={};return Object.keys(t).forEach((n=>{e[n]=Re(t[n])})),e}throw new TypeError(`${te(t)} value is not supported`)}function be(t,e,n){ee(n)&&ye(Wt(n)?n:()=>n,(()=>{t.setData({[e]:Re(n)},_e)}),{deep:!0})}const me=(t,e,n,...s)=>{if(e&&e[n]&&e[n](...s),!t[`$${n}`])return;const o={onLoad:"onUnload",onShow:"onHide",attached:"detached"}[n];t[`$${n}`].forEach((e=>{if(o){const n=t[`$${o}`]&&t[`$${o}`].find((t=>t.front===e));n&&n()}const n=e.apply(t,s);if(o&&"function"==typeof n){t[`$${o}`]&&t[`$${o}`].find((t=>t.front===e))||(n.front,t[`$${o}`]||(t[`$${o}`]=[]),t[`$${o}`].push(n))}}))},$e=(t,e,n,...s)=>{if(e&&e[n])return e[n](...s);if(t[`$${n}`]){if(t[`$${n}`].length)throw new Error(`一个page只能配置一个${n}`);return t[`$${n}`][0].apply(t,s)}},Oe=(t,e,n)=>{t&&(t[`$${e}`]||(t[`$${e}`]=[]),t[`$${e}`].push(n))};let Ee=null;const ke=()=>Ee;let Le=null;const Pe=()=>Le;t.EffectScope=y,t.ReactiveEffect=b,t.attached=t=>Oe(ke(),"attached",t),t.computed=function(t,e,s=!1){let o,r;const i=a(t);return i?(o=t,r=n):(o=t.get,r=t.set),new zt(o,r,i||!r,s)},t.customRef=function(t){return new qt(t)},t.defineComponent=t=>{if(!t)return Component({});let e={};if("function"!=typeof t){const{setup:n,...s}=t;e=s,t=n}if(!t)return Component(e);let n=null;e.properties&&(n=Object.keys(e.properties)),n&&(void 0===e.observers&&(e.observers={}),n.forEach((t=>{const n=e.observers[t];e.observers[t]=function(e){this.$props&&(this.$props[t]=e),void 0!==n&&n.call(this,e)}}))),Component({...e,lifetimes:{attached(){Ee=this,this.$scope=w();const s={};n&&n.forEach((t=>{s[t]=this.data[t]})),this.$props=Lt(s),this.$context={emit:(t,e)=>{this.triggerEvent(t,{value:e})}},this.$scope.run((()=>{const n=t.call(this,this.$props,this.$context);void 0!==n&&Object.keys(n).forEach((t=>{const e=n[t];se(e)?this[t]=e:(this.setData({[t]:Re(e)}),be(this,t,e))})),me(this,e,"attached")})),Ee=null},ready(){me(this,e,"ready")},moved(){me(this,e,"moved")},detached(){me(this,e,"detached"),this.$scope&&this.$scope.stop(),Object.keys(this).forEach((t=>{try{/^$/.test(t)&&delete this[t]}catch(t){console.error("销毁异常",t)}}))},error(t){me(this,e,"error",t)}}})},t.definePage=t=>{if(!t)return Page({});let e={};if("function"!=typeof t){const{setup:n,...s}=t;e=s||{},t=n}if(!t)return Page(e);const{queries:n,...s}=e;Page({...s,onLoad(s){Le=this,this.$scope=w(),this.$query=((t,e)=>{if(!e)return t;let n={};for(let s in t)if(s in e){const o=t[s],r=e[s];if(!r){n[s]=o;break}const i=r.type||r,c=t=>"formatter"in r&&void 0!==r.formatter?r.formatter(t):i===Boolean?!!t:i===Number?Number(t):i===Object?t?JSON.parse(decodeURIComponent(t)):{}:i===Array?t?JSON.parse(decodeURIComponent(t)):[]:(null===i||i===String||console.error("未知的·type·",i),t);n[s]=c(o)}else n[s]=t[s];return n})(s,n),this.$context={},this.$scope.run((()=>{const n=t.call(this,this.$query,this.$context);void 0!==n&&Object.keys(n).forEach((t=>{const e=n[t];se(e)?this[t]=e:(this.setData({[t]:Re(e)}),be(this,t,e))})),me(this,e,"onLoad",s)})),Le=null},onShow(){me(this,e,"onShow")},onReady(){me(this,e,"onReady")},onHide(){me(this,e,"onHide")},onUnload(){me(this,e,"onUnload"),this.$scope&&this.$scope.stop(),Object.keys(this).forEach((t=>{try{/^$/.test(t)&&delete this[t]}catch(t){console.error("销毁异常",t)}}))},onRouteDone(){me(this,e,"onRouteDone")},onPullDownRefresh(){me(this,e,"onPullDownRefresh")},onReachBottom(){me(this,e,"onReachBottom")},onPageScroll(t){me(this,e,"onPageScroll",t)},onAddToFavorites(t){return $e(this,e,"onAddToFavorites",t)},onShareAppMessage(t){return $e(this,e,"onShareAppMessage",t)},onShareTimeline(){return $e(this,e,"onShareTimeline")},onResize(t){me(this,e,"onResize",t)},onTabItemTap(t){me(this,e,"onTabItemTap",t)},onSaveExitState(){me(this,e,"onSaveExitState")}})},t.detached=t=>Oe(ke(),"detached",t),t.effect=function(t,e){t.effect instanceof b&&(t=t.effect.fn);const o=new b(t,n,(()=>{o.dirty&&o.run()}));e&&(s(o,e),e.scope&&S(o,e.scope)),e&&e.lazy||o.run();const r=o.run.bind(o);return r.effect=o,r},t.effectScope=w,t.error=t=>Oe(ke(),"error",t),t.getCurrentScope=R,t.isProxy=At,t.isReactive=xt,t.isReadonly=It,t.isRef=Wt,t.isShallow=Tt,t.markRaw=function(t){return Object.isExtensible(t)&&((t,e,n,s=!1)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,writable:s,value:n})})(t,"__v_skip",!0),t},t.moved=t=>Oe(ke(),"moved",t),t.onAddToFavorites=t=>Oe(Pe(),"onAddToFavorites",t),t.onHide=t=>Oe(Pe(),"onHide",t),t.onLoad=t=>Oe(Pe(),"onLoad",t),t.onPageScroll=t=>Oe(Pe(),"onPageScroll",t),t.onPullDownRefresh=t=>Oe(Pe(),"onPullDownRefresh",t),t.onReachBottom=t=>Oe(Pe(),"onReachBottom",t),t.onReady=t=>Oe(Pe(),"onReady",t),t.onResize=t=>Oe(Pe(),"onResize",t),t.onRouteDone=t=>Oe(Pe(),"onRouteDone",t),t.onSaveExitState=t=>Oe(Pe(),"onSaveExitState",t),t.onScopeDispose=function(t){v&&v.cleanups.push(t)},t.onShareAppMessage=t=>Oe(Pe(),"onShareAppMessage",t),t.onShareTimeline=t=>Oe(Pe(),"onShareTimeline",t),t.onShow=t=>Oe(Pe(),"onShow",t),t.onTabItemTap=t=>Oe(Pe(),"onTabItemTap",t),t.onUnload=t=>Oe(Pe(),"onUnload",t),t.proxyRefs=function(t){return xt(t)?t:new Proxy(t,Kt)},t.reactive=kt,t.readonly=Pt,t.ready=t=>Oe(ke(),"ready",t),t.ref=Ut,t.shallowReactive=Lt,t.shallowReadonly=function(t){return jt(t,!0,tt,bt,Et)},t.shallowRef=function(t){return Bt(t,!0)},t.stop=function(t){t.effect.stop()},t.toRaw=Mt,t.toRef=function(t,e,n){return Wt(t)?t:a(t)?new Yt(t):l(t)&&arguments.length>1?Gt(t,e,n):Ut(t)},t.toRefs=function(t){const e=i(t)?new Array(t.length):{};for(const n in t)e[n]=Gt(t,n);return e},t.toValue=function(t){return a(t)?t():Ft(t)},t.triggerRef=function(t){Ct(t,4)},t.unref=Ft,t.useComponent=ke,t.usePage=Pe,t.watch=ye,t.watchEffect=function(t,e){return we(t,null,e)},t.watchPostEffect=function(t,e){return we(t,null,/* istanbul ignore next -- @preserve */{flush:"post"})},t.watchSyncEffect=function(t,e){return we(t,null,/* istanbul ignore next -- @preserve */{flush:"sync"})}}));
